...
\newcommand*\diff{\mathop{}\!\mathrm{d}}             % as the differential 
                                                       % operator, e.g. 
                                                       % \frac{\d x}{\d t}
...
% {\marginpar{\textbf{\textcolor{expcolor}{ToDo}}}{}}
% \newcommand{\todo}[1]
% {{\textbf{\textcolor{expcolor}{[\margtodo{}#1]}}}{}}   % for todo-notes inside 
%                                                        % the document
...
\includegraphics[#2]{#3}                   % with all necessary vars
\xcaption{#4}{#5}
\label{fig:#3}
\end{figure}}

\newcommand{\xfigpdf}[5]{\begin{figure}[#1]            % a quick command for
\centering                                             % including graphics 
\includegraphics[#2]{./include/images/#3}                   % with all necessary vars
\xcaption{#4}{#5}
\label{fig:#3}
\end{figure}}

%Beispiel
%\xfigure{h}{1}{stehend.png}{}{n-te Harmonische einer schwingenden Saite\cite{Tipler}}
