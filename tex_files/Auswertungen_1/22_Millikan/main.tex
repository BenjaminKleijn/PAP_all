...
\newcommand{\versuchnummer}{22}
\newcommand{\versuch}{Millikan: Bestimmung der Elementarladung}	%Versuch
\newcommand{\tutor}{Louis Laschinger }		            % Tutor:in
\newcommand{\Termin}{26.09.25}	
\newcommand{\releaseDate}{10.10.2025}				% Blockdeadline
