...
\newcommand{\versuchnummer}{25}
\newcommand{\versuch}{Oszilloskop}	%Versuch
\newcommand{\tutor}{Jonathan Rodemers }		            % Tutor:in
\newcommand{\Termin}{1.10.25}	
\newcommand{\releaseDate}{27.10.2025}				% Blockdeadline
...
\begin{document}
    ...
    \endgroup
    \hypersetup{urlcolor=blueurllink}                     % back to blueurllink
    \vfill
    \appendix
