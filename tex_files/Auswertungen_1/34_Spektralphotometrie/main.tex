...
\newcommand{\versuchnummer}{34}
\newcommand{\versuch}{Spektralphotometrie}	%Versuch
\newcommand{\tutor}{Marcel Konrad Zymela}		            % Tutor:in
\newcommand{\Termin}{09.09.25}	
\newcommand{\releaseDate}{27.09.2025}				% Blockdeadline
