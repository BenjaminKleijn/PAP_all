...
\newcommand{\versuchnummer}{41}
\newcommand{\versuch}{Temperaturmessung}	%Versuch
\newcommand{\tutor}{Samuel Remmers}		            % Tutor:in
\newcommand{\Termin}{12.09.25}	
\newcommand{\releaseDate}{4.10.2025}				% Blockdeadline
