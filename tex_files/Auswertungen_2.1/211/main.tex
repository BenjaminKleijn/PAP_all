...
\graphicspath{{./images/}{../Code/211/Diagramme}}
...
\newcommand{\versuchnummer}{211}
\newcommand{\versuch}{Gekoppelte Pendel}
\newcommand{\tutor}{Dimitrij Bathauer}               % Tutor:in
\newcommand{\Termin}{19.02.2026}	
...
\begin{document}
    \backgroundsetup{scale=1,position={8.0,-18.4cm},angle=180,opacity=0.5,contents={\includegraphics{pendelasym.png}}}    
