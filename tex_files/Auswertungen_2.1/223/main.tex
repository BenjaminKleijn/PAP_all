...
\graphicspath{{./images/}{../Code/223/Diagramme}}
...
\newcommand{\versuchnummer}{223}
\newcommand{\versuch}{Brownsche Bewegung}
\newcommand{\tutor}{Fabian Mrosek}               % Tutor:in
\newcommand{\Termin}{5.03.2026}	
