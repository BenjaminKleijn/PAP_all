...
\graphicspath{{./images/}{../Code/234/Diagramme}}
...
\newcommand{\versuchnummer}{234}
\newcommand{\versuch}{Gitterspektrometer}    %Versuch
...
\begin{document}
    ...
    \node[anchor=north east, opacity=1] at ([xshift=-0.2cm, yshift=-4cm]current page.north east) {
        \includegraphics[width=2cm]{Meme2_My_Time_Has_Come.jpg}
    };
    }
    \listoffigures
    \listoftables
