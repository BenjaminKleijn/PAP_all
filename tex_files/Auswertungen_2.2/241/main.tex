...
\graphicspath{{./images/}{../Code/241/Diagramme}}
...
\newcommand{\versuchnummer}{241}
\newcommand{\versuch}{RLC-Schwingkreis}
\newcommand{\tutor}{Till Gero Friedhelm Krause}               % Tutor:in
\newcommand{\Termin}{5.05.2026}	
