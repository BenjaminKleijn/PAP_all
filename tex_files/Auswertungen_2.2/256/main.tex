...
\graphicspath{{./images/}{../Code/256/Diagramme}}
...
\newcommand{\versuchnummer}{256}
\newcommand{\versuch}{X-ray fluorescence}
\newcommand{\tutor}{Frisco Grace}               % Tutor:in
\newcommand{\Termin}{28.04.2026}	
